...
.. code-block:: bash
    ...
    cd locmaster
    celery -A locmaster.taskapp worker -l info
...
To run the tests, enter the locmaster/tests directory and run the following commands::
